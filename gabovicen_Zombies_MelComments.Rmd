...
*too small? or does it have to do with type of variable? -Mel*
...
*what is mh here? I think you forgot to assign your means to objects*
*When finding CI, you should not use qnorm on a non-normal distribution*
...
*you want to pull samples for each variable, and then find their mean/sd/CI after checking if they are all normal*